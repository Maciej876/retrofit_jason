                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                            if(sprawdzOdpowiedz(aktualnePytanie)){
                                ...
                                Toast.makeText(MainActivity.this, "źle", Toast.LENGTH_SHORT);
                            }
                        ...
                        //TODO:koniec tekstu
                            //podliczenie puktow znika wszystko wysylamy wynik sms
                            radioGroup.setVisibility(View.INVISIBLE);
                            textViewPytanie.setText("Koniec testu, punkty: "+sumaPunktów);
        ...
        buttonPodziel.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intentWyslij.putExtra(Intent.EXTRA_TEXT, "otrzymano: "+sumaPunktów);
